...
```typescript
connectReader(options: { reader: ReaderInterface; autoReconnectOnUnexpectedDisconnect?: boolean; merchantDisplayName?: string; tosAcceptancePermitted?: boolean; onBehalfOf?: string; locationId?: string; }) => Promise<void>
```

| Param         | Type                                                                                                                                                                                                                              |
| ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`options`** | <code>{ reader: <a href="#readerinterface">ReaderInterface</a>; autoReconnectOnUnexpectedDisconnect?: boolean; merchantDisplayName?: string; tosAcceptancePermitted?: boolean; onBehalfOf?: string; locationId?: string; }</code> |
